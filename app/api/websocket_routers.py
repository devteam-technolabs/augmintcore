...
# this is updated code for new requirement
...
# from app.websocket.coinbase import coinbase_ws_listener, fetch_coinbase_stats, fetch_coinbase_products
...
#                         # 2. Fetch History from Coinbase
#                         candles = await fetch_candles(state["symbol"], state["granularity"])
#                         if candles:
