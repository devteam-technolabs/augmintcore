...
from app.models.user import Subscription, SubscriptionStatus, Transaction, User
...
class PaymentService:
    ...
    async def handle_subscription_updated(
        self, db: AsyncSession, stripe_subscription_id: str, cancel_at_period_end: bool
    ):
        result = await db.execute(
        ...
        if cancel_at_period_end:
            subscription.status = (
                "cancelled"  # Mark as cancelled (but still active until period end)
            )
    ...
    async def handle_subscription_deleted(
        self, db: AsyncSession, stripe_subscription_id: str, event_data: dict
    ):
    ...
    async def handle_auto_renewal(
        self, db: AsyncSession, event_data: dict, event_id: str
    ):
