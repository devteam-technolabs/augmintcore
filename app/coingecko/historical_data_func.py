...
cg = AsyncCoingecko(pro_api_key=COINGECKO_PRO_API_KEY, environment="pro")
TIMEFRAME_MAP = {"1h": 1, "24h": 1, "7d": 7, "1m": 30, "1y": 365, "all": "max"}
...
async def get_data_chart(coin_id: str, timeframe: str):
    ...
    data = await cg.coins.market_chart.get(id=coin_id, vs_currency="usd", days=days)
    result = []
    print("data", data)
    result.append(
        {
